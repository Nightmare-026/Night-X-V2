    ...
    <div className="min-h-screen bg-black text-white pt-24 pb-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto space-y-20">
        ...
        <section className="text-center">
          ...
          >
            About <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-600">Night X</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Night X was born out of a simple frustration: why should developers, creators, and professionals juggle dozens of ad-ridden, slow, and ugly websites just to perform basic utility tasks?
          </motion.p>
        </section>
        ...
        >
          ...
          <p className="text-lg text-gray-300 leading-relaxed mb-6">
            We believe that powerful tools should be beautiful, fast, and accessible. We are building the ultimate utility hub—a single, unified workspace where you can compress images, generate secure passwords, encode data, and interact with AI, all within a seamless, distraction-free environment.
          </p>
          <p className="text-lg text-gray-300 leading-relaxed">
            By leveraging cutting-edge web APIs, WebAssembly, and edge computing, Night X brings desktop-grade performance directly to your browser. No installations. No context switching. Just pure productivity.
          </p>
        </motion.section>
