...
export const CATEGORIES: CategoryMeta[] = [
  { id: 'all', label: 'All Tools', icon: 'Wrench', description: 'Everything in one place', color: 'var(--accent-purple)' },
  { id: 'image', label: 'Image Tools', icon: 'Image', description: 'Compress, resize, and convert images', color: 'var(--accent-cyan)' },
  { id: 'security', label: 'Security', icon: 'Shield', description: 'Passwords, encryption, and hashing', color: '#EF4444' },
  ...
  { id: 'utility', label: 'Utilities', icon: 'Settings', description: 'QR codes, short links, and more', color: '#6366F1' },
  { id: 'life', label: 'Daily Life', icon: 'Calendar', description: 'Calculators and everyday helpers', color: '#EC4899' },
  { id: 'ai', label: 'AI Tools', icon: 'Bot', description: 'AI-powered writing and assistant tools', color: '#8B5CF6' },
];
